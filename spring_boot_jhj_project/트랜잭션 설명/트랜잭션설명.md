...
=======================================================================================
트랜잭션 활용
1. 최대한 Spring Transection Annotation 형식으로 트랜잭션 구현
2. INSERT, UPDATE, DELETE 기본적으로 두개 이상 들어가는 로직은 반드시 트랜잭션 처리
3. 최대한 로직을 서비스단에서 만들기 때문에 @Transectional은 서비스단 함수에 붙일수 있도록 프로그램을 짜는 것이 최선
4. 컨트롤러 단에서 @Transectional을 명시하는것은 금지